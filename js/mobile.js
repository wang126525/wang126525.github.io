...
/******/ 	return __webpack_require__(__webpack_require__.s = "./source-src/js/mobile.js");
/******/ })
/************************************************************************/
/******/ ({
...
function init() {
	...
	if (window.themeConfig && window.themeConfig.toc_hide_index) {
		var $a = document.querySelectorAll('.toc-number');
...
var _fix = __webpack_require__(/*! ./fix */ "./source-src/js/fix.js");
