(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["photo-wall"],{

/***/ "./source-src/js/photo-wall.js":
/*!*************************************!*\
  !*** ./source-src/js/photo-wall.js ***!
  \*************************************/
...
// 滚动区域DOM
var scrollDom = document.getElementById('container');
// 作为底部标记的DOM
var markDom = document.getElementById('footer');
// 加载提示文字
...
function loadMoreItems(step) {
  ...
  // 滚动到底部时调用
  _axios2.default.get(themeConfig.root + 'api/common/photos', { params: { start: totalIndex, limit: step } }).then(function (res) {
    var itemContainer = document.createElement('div');
    for (var index = 0; index < res.data.data.length && totalIndex < res.data.total; index++, totalIndex++) {
      var imgHeight = null,
          imgFile = res.data.data[index],
          imgSrc = themeConfig.pictureCdn + '/' + imgFile.name,
          imgThumbnail = imgFile.thumbnail ? themeConfig.pictureCdn + '/' + imgFile.thumbnail : imgSrc;
      var wrapperWidth = photoWallWrapper.getBoundingClientRect().width;
      // 列宽240px 列间距20px, 计算每列宽度
      var columnWidth = (wrapperWidth + 20) / Math.floor((wrapperWidth + 20) / (240 + 20)) - 20;
      // 图片的实际显示高度
...
//# sourceMappingURL=photo-wall.js.map