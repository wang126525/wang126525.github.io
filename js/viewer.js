...
/******/ 	return __webpack_require__(__webpack_require__.s = "./source-src/js/viewer.js");
/******/ })
/************************************************************************/
/******/ ({
...
var _photoswipe = __webpack_require__(/*! ../lib/photoswipe/photoswipe */ "./source-src/lib/photoswipe/photoswipe.js");

var _photoswipe2 = _interopRequireDefault(_photoswipe);

var _photoswipeUiDefault = __webpack_require__(/*! ../lib/photoswipe/photoswipe-ui-default */ "./source-src/lib/photoswipe/photoswipe-ui-default.js");

var _photoswipeUiDefault2 = _interopRequireDefault(_photoswipeUiDefault);

__webpack_require__(/*! ../lib/photoswipe/photoswipe.css */ "./source-src/lib/photoswipe/photoswipe.css");

__webpack_require__(/*! ../lib/photoswipe/default-skin/default-skin.css */ "./source-src/lib/photoswipe/default-skin/default-skin.css");
...
function init() {
  ...
  var getThumbBoundsFn = function getThumbBoundsFn(target) {
    return function (index) {
      // index是当前点击的图片在相册中的索引值
      var pageYScroll = window.pageYOffset || document.documentElement.scrollTop;
      var rect = target.getBoundingClientRect();
      return { x: rect.left, y: rect.top + pageYScroll, w: rect.width };
    };
  };
  var items = Array.prototype.map.call(imgArr, function (em) {
    var src = em.getAttribute('data-target') || em.getAttribute('src');
    var title = em.getAttribute('alt');
    // 获得原图尺寸
    var image = new Image();
    image.src = src;
    return {
  ...
  Array.prototype.forEach.call(imgArr, function (em, index) {
...
if (!window.themeConfig.pageid) {
  // 非个性化页面的普通文章
  _util2.default.addLoadEvent(init);
}

/***/ }),

/***/ "./source-src/lib/photoswipe/default-skin/default-skin.css":
/*!*****************************************************************!*\
  !*** ./source-src/lib/photoswipe/default-skin/default-skin.css ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./source-src/lib/photoswipe/photoswipe-ui-default.js":
/*!************************************************************!*\
  !*** ./source-src/lib/photoswipe/photoswipe-ui-default.js ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./source-src/lib/photoswipe/photoswipe.css":
/*!**************************************************!*\
  !*** ./source-src/lib/photoswipe/photoswipe.css ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "./source-src/lib/photoswipe/photoswipe.js":
/*!*************************************************!*\
  !*** ./source-src/lib/photoswipe/photoswipe.js ***!
  \*************************************************/
/*! no static exports found */
			...
			framework.bind = function (target, type, listener, unbind) {
				...
				for (var i = 0; i < type.length; i++) {
					...
					if (evName) {
						...
						if ((typeof listener === 'undefined' ? 'undefined' : (0, _typeof3.default)(listener)) === 'object' && listener.handleEvent) {
							if (!unbind) {
